...
public record InstanceListResponse(
    ...
    /**
     * 알림 심각도를 포함한 인스턴스 목록 응답 생성
     * 
     * @param instance 인스턴스 엔티티
     * @param maxSeverity 최고 심각도 (null=알림 없음, 1=주의, 2=위험, 3=치명)
     */
    public static InstanceListResponse from(Instance instance, Integer maxSeverity) {
